...
namespace Xe.Tools.Components.MapEditor.Models
{
    public class AnimationDataEntry
    {
        ...
        public FramesGroup GetAnimation(string animationName, Direction direction = Direction.Unspecified)
        {
            var animationRef = _animationData.AnimationDefinitions
                .SingleOrDefault(x => x.Name == animationName);
